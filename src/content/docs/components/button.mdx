---
title: Buttons
description: A simple and beautiful UI template Buttons.
---
...
<Tabs>
  ...
  <TabItem label="Preview">
    <div class="space-y-4 grid ">
      <div class="space-x-4">
        <button class="py-2 px-6 bg-transparent border border-white hover:bg-white hover:text-black hover:border-transparent text-base rounded-md cursor-pointer">
          Default
        </button>
...
{/* HTML Code here */}
  ...
  <TabItem label="HTML">
    ```html
        <button class="py-2 px-6 bg-transparent border border-white hover:bg-white hover:border-transparent hover:text-black text-base rounded-md cursor-pointer">
          Default
        </button>
        <button class="py-2 px-6 bg-transparent border border-[#58c7f4] hover:bg-[#58c7f4] hover:border-transparent text-base rounded-md cursor-pointer">
          Copy
